...
void Sol(){
  ...
  */
  ...
  int i = 1;
  Serial.write((byte*)&i, sizeof(nombre));/*envoi du signal pour commencer les mesures*/
}

int stop(){
  void; /*fonction à remplir*/
}
...
void Vol(){
  ...
  */
  ...
  int i = 2;
  Serial.write((byte*)&i, sizeof(nombre));/*envoi du signal pour arrêter les mesures, on pourra l'enlever si on sait à quel moment la fusée est au sol pour un arrêt automatique*/
}

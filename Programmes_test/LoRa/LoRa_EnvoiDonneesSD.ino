...
//SD
    ...
    myFile.print(":");
    myFile.print(count_ms);
    myFile.print("Donnée n°");
    myFile.print(counter);

    myFile.print("Acceleration X: ");
    myFile.print(acc.acceleration.x);
    myFile.print(", Y: ");
    myFile.print(acc.acceleration.y);
    myFile.print(", Z: ");
    myFile.print(acc.acceleration.z - 9.81);
    myFile.print(" m/s^2");

    myFile.print("Rotation X: ");
    myFile.print(gyr.gyro.x);
    myFile.print(", Y: ");
    myFile.print(gyr.gyro.y);
    myFile.print(", Z: ");
    myFile.print(gyr.gyro.z);
    myFile.print(" rad/s");
